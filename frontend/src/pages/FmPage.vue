...
onMounted(() => {
  ...
  radio.setLocation('bar')
})
onUnmounted(() => {
  // 离开酒馆默认回到 floor（Floor 页 onMounted 也会再上报一次，幂等）
    ...
    <div class="container">
      <header class="topbar">
        <div class="row" style="gap:10px">
          <router-link to="/" class="pix-btn ghost back-btn"
                       style="font-size:8px;padding:6px 8px;text-decoration:none">
            ← FLOOR
          </router-link>
          <div class="logo floaty">
            <span style="color:var(--orange-d)">T</span><span>H</span><span style="color:var(--green)">E</span>
            <span style="margin:0 4px">·</span>
            <span style="color:var(--orange)">B</span><span>A</span><span>R</span>
          </div>
          <span class="by-cg muted">vibe lounge</span>
        </div>
        <div class="row" style="gap:10px">
          <OnlineList/>
